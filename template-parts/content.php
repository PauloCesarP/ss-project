<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="relative pt-16 before:absolute before:top-0 before:left-0 before:h-px before:w-6 before:bg-zinc-950 after:absolute after:top-0 after:right-0 after:left-8 after:h-px after:bg-zinc-950/10">
        <div class="relative lg:-mx-4 lg:flex lg:justify-end">
            ...
            <h2 class="text-2xl font-semibold text-neutral-950"><a href="<?php the_permalink(); ?>" class="!no-underline"><?php the_title(); ?></a></h2>
            <dl class="lg:absolute lg:top-0 lg:left-0 lg:w-1/3 lg:px-4">
                ...
                <dd class="absolute top-0 left-0 text-sm text-neutral-950 lg:static">
                    <time datetime="<?php echo get_the_date( 'c' ); ?>" itemprop="datePublished" class="text-sm text-neutral-700"><?php echo get_the_date(); ?></time>
                </dd>
            ...
            <div class="mt-6 max-w-2xl text-base text-neutral-600">
                <?php the_excerpt(); ?>
            </div>
