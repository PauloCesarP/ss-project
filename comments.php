...
<div id="comments" class="comments-area my-10 sm:my-20 mx-auto max-w-3xl">
    <?php if (have_comments()): ?>
        <h2 class="comments-title text-3xl font-medium text-shadow-neutral-600 mb-8">
            <?php
            printf(
                esc_html(_nx(
                    'One comment',
    ...
    <?php if (!comments_open() && get_comments_number() && post_type_supports(get_post_type(), 'comments')): ?>
        <p class="no-comments text-neutral-600"><?php esc_html_e('Comments are closed.', 'tailpress'); ?></p>
    <?php endif; ?>
